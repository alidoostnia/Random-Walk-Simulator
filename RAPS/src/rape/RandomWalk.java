...
public class RandomWalk {
    ...
    public Object[] SRW(int dim, int pack[], int CT){
        int rw[]=new int[15000]; //random walk
        int total=0;
        int i=0; //number of steps
        int select=0;
        int point[][]=new int[15000][4];
        ...
        while(total<CT){
            ...
            if(select==0){
                ...
                System.out.println("error with select value");
            }
            
            
            total=total+pack[select]-20; //20B for TCP header
    ...
    public Object[] SARW(int dim, int pack[], int CT){
        int rw[]=new int[10000]; //random walk
        int total=0;
        int i=0; //number of steps
        int select=0;
        int point[][]=new int[10000][4];
    ...
    public int Move(int current, int point [][], int dim) {
           ...
           if(visited==0)//if not visited, check for avalability in neighborhood 
            ...
            if(visited==0 )//if not previously visited and avalable add to the list
            {
               if(dim==2 && vcount<3)//atleast two avalable path in two direction
                 ...
                 System.out.println("error with dimension value");  
       ...
       // for(int l=0;l<20;l++)
        ...
        {
            System.out.println("dead lock with ");
